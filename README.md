...
> **Status:** `v0.9.0` — Phase 0 done, Phase 1 underway. `iron-partition`
...
> AS-REQ/AS-REP with pre-auth, TGS-REQ/TGS-REP, keytab I/O + export), and
> `iron-dns` (LDAP/Kerberos SRV record publishing via MicroDNS) are real and
